...
class RecentAdvertsPage extends StatefulWidget {
  const RecentAdvertsPage({super.key});

  @override
  State<RecentAdvertsPage> createState() => _RecentAdvertsPageState();
}

class _RecentAdvertsPageState extends State<RecentAdvertsPage> {
  int _page = 1;
      ...
      body: BlocBuilder<ManageHomeBloc, ManageHomeState>(
        builder: (context, state) {
          if (state.getStatus is HomeGetSuccess) {
            ...
            final advert = success.allAdverts;
